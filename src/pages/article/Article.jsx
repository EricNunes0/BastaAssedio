    ...
    return (
        <article id="article">
            <div id="article-first">
                <div id="article-flex">
                    <aside id="article-left">
                        <ArticleImage id="first" alt="Pensando" src="/images/pensando.png"></ArticleImage>
                    </aside>
                    <div className="article-content" id="first">
            ...
            <div id="article-second">
                <div id="article-flex">
                    <div className="article-content" id="second">
            ...
            <div id="article-forth">
                <div id="article-flex">
                    ...
                    <div className="article-content" id="forth">
